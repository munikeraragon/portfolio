export const HtmlIcon: React.FC = () => {
	return (
		<svg version='1.1' viewBox='0 0 512 512' className='h-16 w-16' xmlns='http://www.w3.org/2000/svg'>
			<g id='形状_1_9_' style={{ background: 'new' }}>
				<g id='形状_1'>
					<g>
						<polygon
			...
			<g id='形状_1_8_' style={{ background: 'new' }}>
				<g id='形状_1_1_'>
					<g>
						<path
			...
			<g id='形状_1_7_' style={{ background: 'new' }}>
				<g id='形状_1_2_'>
					<g>
						<polygon
			...
			<g id='形状_1_6_' style={{ background: 'new' }}>
				<g id='形状_1_3_'>
					<g>
						<path
			...
			<g id='形状_1_5_' style={{ background: 'new' }}>
				<g id='形状_1_4_'>
					<g>
						<path
