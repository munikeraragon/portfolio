!(function () {
	...
	var Ht =
			...
			function (t, e) {
				...
				return (
					null !== t
						? ((Gt.prototype = R(t)), (r = new Gt()), (Gt.prototype = null), (r[Kt] = t))
						: (r = Vt()),
					void 0 === e ? r : zt(r, e)
				)
			},
	...
	kt(
		{ target: 'Array', proto: !0 },
		{
			flatMap: function (t) {
				...
				return (
					Qt(t),
					((e = oe(r, 0)).length = we(e, r, r, n, 0, 1, t, arguments.length > 1 ? arguments[1] : void 0)),
					e
				)
			},
		}
	...
	var Se,
		...
		Te = Dt('iterator'),
		ke = !1
	;[].keys && ('next' in (xe = [].keys()) ? (Ee = Ie(Ie(xe))) !== Object.prototype && (Se = Ee) : (ke = !0)),
		null == Se && (Se = {}),
		b(Se, Te) ||
			I(Se, Te, function () {
				return this
		...
		Xe = function (t, e, r, n, o, i, a) {
			...
			if (
				(g &&
					...
					ze !== Object.prototype &&
						u.next &&
						(Ie(u) !== ze && (qe ? qe(u, ze) : 'function' != typeof u[Ke] && I(u, Ke, He)), _e(u, l, !0))),
				o == $e &&
					d &&
					d.name !== $e &&
					((h = !0),
		...
		Gr = {
			getConstructor: function (t, e, r, n) {
				var o = t(function (t, a) {
						_r(t, o, e),
							Wr(t, { type: e, index: Ht(null), first: void 0, last: void 0, size: 0 }),
							i || (t.size = 0),
							null != a && Mr(a, t[n], t, r)
					}),
					a = Kr(e),
				...
				return (
					Fr(o.prototype, {
						...
						forEach: function (t) {
							for (
								var e, r = a(this), n = Zt(t, arguments.length > 1 ? arguments[1] : void 0, 3);
								(e = e ? e.next : r.first);
	...
	var mo = {
			getConstructor: function (t, e, r, n) {
				var o = t(function (t, i) {
						_r(t, o, e), co(t, { type: e, id: po++, frozen: void 0 }), null != i && Mr(i, t[n], t, r)
					}),
					i = fo(e),
					a = function (t, e, r) {
						var n = i(t),
	...
	if (
		...
		for (
			var ci = function (t, e) {
					...
					ui ? o && !i && (t = t.source) : t instanceof ci && (i && (e = Yo.call(t)), (t = t.source)),
	...
	kt({ target: 'RegExp', proto: !0, forced: /./.exec !== Ei }, { exec: Ei }),
		i && ('g' != /./g.flags || Qo.UNSUPPORTED_Y) && P.f(RegExp.prototype, 'flags', { configurable: !0, get: Yo })
	var xi = tt.get,
		Ai = RegExp.prototype
	i &&
		Qo.UNSUPPORTED_Y &&
	...
	ea
		...
		: Qi && (!(Yi = Qi.match(/Edge\/(\d+)/)) || Yi[1] >= 74) && (Yi = Qi.match(/Chrome\/(\d+)/)) && (Ji = Yi[1])
	var ra = Ji && +Ji,
		na = Dt('species'),
	...
	var fa = bt.f,
		...
		Da = function (t, e, r) {
			...
			return (
				...
				b(Ta, n)
					? (r.enumerable
							? (b(t, ma) && t[ma][n] && (t[ma][n] = !1), (r = Ht(r, { enumerable: c(0, !1) })))
	...
	if (
		...
		kt({ target: 'Object', stat: !0, forced: !_t }, { getOwnPropertyNames: Ka, getOwnPropertySymbols: Ga }),
		kt(
			{
				target: 'Object',
				stat: !0,
	...
	var pu =
		...
		vu = function (t) {
			return function (e, r, n) {
				...
				return c <= u || '' == s
					? a
					: ((i = pu.call(s, du((o = c - u) / s.length))).length > o && (i = i.slice(0, o)),
					  t ? a + i : i + a)
			}
		},
			...
			o(function () {
				...
				? function (t, e) {
						for (var r = Lt(t), n = arguments.length, o = 1, a = wt.f, u = s.f; n > o; )
							for (
								var c, f = p(arguments[o++]), l = a ? qt(f).concat(a(f)) : qt(f), h = l.length, d = 0;
								h > d;
		...
		cs = function (t, e) {
			if (e)
				for (var r, n, o = e.split('&'), i = 0; i < o.length; )
					(r = o[i++]).length && ((n = r.split('=')), t.push({ key: os(n.shift()), value: os(n.join('=')) }))
		},
		fs = function (t) {
	...
	Fr(
		ds,
		{
			...
			forEach: function (t) {
				for (
					var e, r = Qu(this).entries, n = Zt(t, arguments.length > 1 ? arguments[1] : void 0, 3), o = 0;
					o < r.length;
					...
					fetch: function (t) {
						...
						return (
							arguments.length > 1 &&
								(g((e = arguments[1])) &&
									cr((r = e.body)) === Xu &&
									((n = e.headers ? new Vu(e.headers) : new Vu()).has('content-type') ||
	...
	var vs,
		...
		Ds = function (t) {
			...
			for (r = [], n = 0; n < e; n++) {
				...
				if (
					((i = 10),
					o.length > 1 && '0' == o.charAt(0) && ((i = ks.test(o) ? 16 : 8), (o = o.slice(8 == i ? 1 : 2))),
					'' === o)
				)
					a = 0
				else {
			...
			for (
				...
				switch (((i = o[f]), c)) {
					...
					case vc:
						if (((t.scheme = 'file'), '/' == i || '\\' == i)) c = gc
							...
							if (i == vs) (t.host = n.host), (t.path = n.path.slice()), (t.query = n.query)
								...
								if ('#' != i) {
									Zs(o.slice(f).join('')) || ((t.host = n.host), (t.path = n.path.slice()), tc(t)),
										(c = bc)
									continue
								}
								;(t.host = n.host),
					...
					case Sc:
						r || '#' != i
							? i != vs &&
							  ("'" == i && Xs(t) ? (t.query += '%27') : (t.query += '#' == i ? '%23' : Vs(i, Ws)))
							: ((t.fragment = ''), (c = Ec))
						break
					case Ec:
	...
	;(Vc && Hc) ||
		...
		'process' == l(Xc)
			...
			: Yc && !Gc
			? ((Wc = (zc = new Yc()).port2), (zc.port1.onmessage = rf), (qc = Zt(Wc.postMessage, Wc, 1)))
			: !n.addEventListener ||
						...
						try {
							l
								? (i || (2 === e.rejection && tl(t, e), (e.rejection = 1)),
								  ...
								  u === f.promise ? p(Ff('Promise-chain cycle')) : (s = Xf(u)) ? s.call(u, h, p) : h(u))
								: p(o)
						} catch (t) {
							d && !c && d.exit(), p(t)
						}
	...
	;(ul.prototype = Ht(Error.prototype, { constructor: c(5, ul), message: c(5, ''), name: c(5, 'AggregateError') })),
		i &&
	...
	;(kl.polyfill = !0),
		self.fetch || ((self.fetch = kl), (self.Headers = bl), (self.Request = Rl), (self.Response = Pl))
